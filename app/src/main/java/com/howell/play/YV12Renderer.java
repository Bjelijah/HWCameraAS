...
//Draw |textures| using |vertices| (X,Y coordinates).
	...
	public void onSurfaceChanged(GL10 gl, int width, int height) {
		...
		int new_h=width*9/16;
			...
			if(width > PhoneConfig.getPhoneWidth(context_) && height > PhoneConfig.getPhoneHeight(context_)){
				GLES20.glViewport((width/4 - width/2), (height - height/2)/2, width, height);
			}else{
	...
	//TODO 闂佸憡鐟崹顖涚閹烘鍎庨悗娑櫭径宥吤归敐鍫熺《闁轰降鍊楅敓钘壩旈崘鎯у墾婵炴垶鎹侀婊呮濠靛洨鈻旂�銉ヮ樇娴犳﹢鎮烽弴姘檭缂侇喚鍨榓w婵炴垶鎼╅崣锟筋敋娴兼潙鐭楅柨鐕傛嫹
...
//		HWCameraActivity.stopProgressBar();
//	}
